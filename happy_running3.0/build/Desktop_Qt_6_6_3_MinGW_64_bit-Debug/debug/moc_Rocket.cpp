...
struct qt_meta_stringdata_CLASSRocketENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRocketENDCLASS = QtMocHelpers::stringData(
    "Rocket"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSRocketENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSRocketENDCLASS_t qt_meta_stringdata_CLASSRocketENDCLASS = {
    {
        QT_MOC_LITERAL(0, 6)   // "Rocket"
    },
    "Rocket"
};
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRocketENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Rocket::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRocketENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Rocket, std::true_type>
    >,
    nullptr
} };
